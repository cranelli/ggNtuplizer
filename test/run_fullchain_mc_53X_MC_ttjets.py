...
#mylist = FileUtils.loadListFromFile ('/data4/cmkuo/fsr/MC_ttjets.txt')
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('job_summer12_ttjets_fsr.root'))
