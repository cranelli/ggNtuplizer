...
mylist = FileUtils.loadListFromFile ('/data4/cmkuo/fsr/RD1_MC_nonFSR.txt')
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ggtree_mc_RD1_nonFSR.root'))
