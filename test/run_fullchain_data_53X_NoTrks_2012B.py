...
mylist = FileUtils.loadListFromFile ('/data4/cmkuo/fsr/2012B_Jan22rereco.txt')
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ggtree_data_2012B.root'))
