...
mylist = FileUtils.loadListFromFile ('/data4/cmkuo/fsr/MC_DYToMuMu5.txt')
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ggtree_mc_S10_5.root'))
