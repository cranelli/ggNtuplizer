...
mylist = FileUtils.loadListFromFile ('/data4/cmkuo/fsr/MC_DYToMuMu2.txt')
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ggtree_mc_S10_2.root'))
