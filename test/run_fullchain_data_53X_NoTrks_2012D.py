...
mylist = FileUtils.loadListFromFile ('/data4/cmkuo/fsr/2012D_Jan22rereco.txt')
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ggtree_data_2012D.root'))
