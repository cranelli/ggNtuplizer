...
mylist = FileUtils.loadListFromFile ('/data4/cmkuo/fsr/MC_Wjets.txt')
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('job_summer12_Wjets_fsr.root'))
